    ...
    <div class="content">
        ...
        <div>
            ...
            <div class="info_user">
                ...
                <div class="course_list" style="margin-left:94px; margin-right:70px; margin-top:330px; margin-bottom:35px;">
                    <div>
                ...
                <!-- giao diện này hiển thị khoảng cách hơi rộng nên sau khi sử dụng if else mới trở về trạng thái như khối trên  -->
                <div class="course_list" style="margin-left:94px; margin-right:70px; margin-top:330px; margin-bottom:35px;">
                    <div>
